...
export default function PWAInstallPrompt() {
  ...
  return (
    <div style={{
      ...
      <div style={{ background: "var(--accent)", padding: "10px", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        <button 
          ...
          style={{ background: "var(--accent)", color: "#111111", border: "none", padding: "6px 12px", borderRadius: "8px", cursor: "pointer", fontWeight: "bold", fontSize: "0.85rem" }}
        >
          Install
        </button>
        <button 
